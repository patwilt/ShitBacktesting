...
### Colour Palette — Flat UI Colors US
All chart series, metric cards, and status indicators use this palette exclusively. No other colours introduced.

```python
# utils/colors.py
COLORS = {
    "mint":       "#00b894",   # Mint Leaf        — FIRE achieved / positive
